...
/*   Updated: 2025/02/06 19:13:54 by emilgarc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# include "source/gnl/get_next_line_bonus.h"
...
# define WRONG_MSG "Error\nLos componentes del mapa no son validos.\n"
# define WALL_MSG "Error\nLas paredes no estan cerradas.\n"
# define MIN_TILES_MSG "Error\nNO he econtrado los compnentes correctos\n"
# define PATH_MSG "Error\nNo hay un camino típico\n"
...
int 	check_mapextension(const char *name); //chequea que la extension es .ber
